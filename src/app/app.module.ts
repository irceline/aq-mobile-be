...
import { CustomDatasetApiInterfaceService } from './services/custom-dataset-api-interface/custom-dataset-api-interface.service';
...
} from './services/language-handler/language-handler.service';
...
} from './services/ongoing-http-cache/ongoing-http-cache.service';
...
@NgModule({
    ...
    providers: [
        ...
        { provide: SettingsService, useClass: JSSONSettingsService },
        {
            ...
            useClass: CustomDatasetApiInterfaceService,
        },
